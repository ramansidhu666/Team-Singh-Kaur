<%@ Page Title="" Language="C#" MasterPageFile="~/PropertyNew.Master" AutoEventWireup="true"   CodeBehind="Terms.aspx.cs" Inherits="Property.Terms" %>
            ...
            <div class="cal_new_cls">
                ...
                <p>
                   Welcome to our website. If you continue to browse and use this website, you are agreeing to comply with and be bound by the following terms 
                    and conditions of use, which together with ourprivacy policy govern this site's owner's relationship with you in relation to this website. 
...
*Your use of this website and any dispute arising out of such use of the website is subject to the laws of Canada.</p>
                ...
                <p>This website is operated by HomeLife Maple Leaf Realty Ltd., Brokerage* who is a member of The Canadian Real Estate Association.</p>
...
Toronto Real Estate Boards's ('TREB') ownership of and the validity of TREB's proprietary rights and copyright in the MLS database, MLS data, TREB's MLS System, and Listing Information
...
Consent to the fact that your Personal Information, including first and last name, email address, and phone number may be collected, used or disclosed. The personal information may be shared with TREB for auditing and/or legal purposes. </p>
