<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="DreamHouse.aspx.cs" validateRequest = false Inherits="Property.Admin.DreamHouse" %>
                     ...
                     <div class="control-group">
                        ...
                        <div class="control-group">
                            <div class="controls">
                                ...
                                <asp:Button ID="BtnUpdate" ValidationGroup="SavePage" runat="server" class="btn btn-primary" Text="Update" OnClick="btnUpdate_Click" />
